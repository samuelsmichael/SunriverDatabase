...
USE SRCitations;
go
alter PROCEDURE [uspCitationsQry-ViolatorHistory2] 
...
--	IIf([FineStatus]="Open","1","0") AS CitationOpen, 
	isnull(c.VLastName,'') as VLastName, isnull(c.VFirstName,'') as VFirstName, c.VMailAddr1, c.VMailAddr2, c.VCity, c.VState, c.VZip, c.VSunriverStatus, 
