<%@ Page Title="About Us" Language="C#" MasterPageFile="~/MainMasterPage.master"
    AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="SubmittalProposal.About" %>
    ...
    <div style="height: 350px; overflow: scroll;">
        <ul>
            ...
            <ul>
                ...
                <li>ComplianceReview now updates and adds</li>
                <li style="font-weight:bold;">When you get the chance, please let me know which of the two Compliance Letter panels you prefer.</li>
            </ul>
            
            <li style="font-weight: bold;">Version .12</li>
            <ul>
                <li>BPermit now updates and adds ... including the Payments and the Review Letters</li>
            </ul>
            </li>
            ...
            <ul>
                ...
                <li>Incorporated "keep record locked" function. Note, currently this function is only
                    working with the Submittals page, since the other two pages don't yet actually perform
                    updates or adds.</li>
            ...
            <ul>
                First Crystal Report</ul>
            <li style="font-weight: bold;">Version .08 </li>
            <ul>
                <li>Search of lane is no longer a "like"-type search. Instead, it's an "exact-match"-type
                    search.</li>
            ...
            <p>
                This completes the "wireframes" construction. Please note that these wireframes
                are for purposes of defining the layout and the flow. They do not perform database
                updates or changes.
            </p>
            <p>
                The steps that follow before going live are:</p>
            <ol>
        ...
        <ul>
            ...
            <ul>
                <li>Search of lot number is no longer a "like"-type search. Instead, it's an "exact-match"-type
                    search.</li>
                <li>Fixed a bug: Compliance Review wasn't coming up.</li>
                <li>Just the first glimpse of how I propose to handle the "new item" function ... using
                    "modal popups". This is available on Submittals, only.</li>
            </ul>
        </ul>
        <ul>
        ...
        <ul>
            ...
            <ul>
                <li>Fixed a problem happening in Chrome: the Compliance Letter (paging) control was
                    being cut-off at the bottom</li>
            </ul>
        </ul>
        <ul>
            ...
            <ul>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <li>There are two versions of the Compliance Letter tab. One uses paging, one uses scrolling.
                            Which do you like better? (ReviewId 144 is an example of 2 Compliance Letters)</li>
                    </ul>
                </ul>
            </ul>
        </ul>
        <ul>
            <li style="font-weight: bold; margin-bottom: 5px; margin-top: 5px;">Version .03
            </li>
            <ul>
                <li>Enhancements</li>
                <ul>
        ...
        <ul>
            <li style="font-weight: bold; margin-bottom: 5px; margin-top: 5px;">Version .02
            </li>
            <ul>
                <li>Enhancements</li>
                <ul>
                    <li>Building Permit page is coded</li>
                    <li>On the Submittal form, the submittal section is on the same tab as the Applicant
                        information</li>
                    <li>Added IsCommercial to Submittals database</li>
                    <li>You can now put *blank into a search textbox, and this means: "items whose value
                        is blank"</li>
