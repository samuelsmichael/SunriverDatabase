<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="BPermitsClosed.aspx.cs" Inherits="SubmittalProposal.Reports.BPermitsClosed" %>
    ...
    <table>
        <tr>
            <td>
                ...
                <td><asp:ImageButton ImageAlign="AbsMiddle" ToolTip="Click to show date selector" ImageUrl="~/Images/Calendar_scheduleHS.png"
                                ID="ibtbFromDate" runat="server" /></td>
                </tr></table>
