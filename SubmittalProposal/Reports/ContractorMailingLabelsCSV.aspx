<%@ Page Title="" Language="C#" MasterPageFile="~/AbstractCSVPage.Master" AutoEventWireup="true"
    CodeBehind="ContractorMailingLabelsCSV.aspx.cs" Inherits="SubmittalProposal.Reports.ContractorMailingLabelsCSV" %>

    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderCSVParms" runat="server">
    <table>
        <tr>
            <td>
                <table>
