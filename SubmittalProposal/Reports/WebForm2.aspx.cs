...
{
    public partial class WebForm2 : AbstractReport
    {
        ...
        protected override CrystalDecisions.CrystalReports.Engine.ReportDocument getReportDocument() {
            return new Contractor.contractorSoonExpLicReport();
        }
        ...
        protected override Hashtable getReportParams() {
            ...
            reportParams.Add("@RegisteredStartDate", Common.Utils.ObjectToDateTime(tbRegDate.Text));
            return reportParams;
        }
