<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="SellCheckUnPaidFees.aspx.cs" Inherits="SubmittalProposal.Reports.SellCheckUnPaidFees" %>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ForeColor="Red" ID="revtbToDate"
