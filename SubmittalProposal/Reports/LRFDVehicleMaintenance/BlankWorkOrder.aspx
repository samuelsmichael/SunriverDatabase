<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlankWorkOrder.aspx.cs" Inherits="SubmittalProposal.Reports.LRFDVehicleMaintenance.BlankWorkOrder" %>
...
<body>
    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="10%"><img alt="La Pine Fire District" class="style1" 
                    longdesc="La Pine Fire District" src="../../Images/lapinelog.png" /></td>
                <td width="70%" align="center">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style=" text-align:center; font-size:14pt; font-weight:bold; border: medium solid #000000; padding-left:2em; padding-right:2em;">La Pine Rural Fire District</td>
                        </tr>
                        <tr>
