        ...
        <ContentTemplate>
                    ...
                    <tr valign="top" align="center">
                        <td valign="top" width="60%" align="center">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <asp:GridView ID="gvUsers" AllowPaging="true" DataKeyNames="UserId" AutoGenerateEditButton="True"
                                            ...
                                            Caption="Users" OnRowCommand="gvUsers_RowCommand" OnPageIndexChanging="gvUsers_PageIndexChanging">
                                            <Columns>
                                ...
                                <tr>
                                    <td>
                                        <asp:Panel BorderColor="Black" BorderStyle="Solid" BorderWidth="1" runat="server" ID="pnlListRoles" Visible="false">
                                            <div runat="server" id="divCheckBoxList" style="height:200px;overflow: auto;">
                                                <asp:CheckBoxList ID="cbListRoles" AutoPostBack="True" CellPadding="2" CellSpacing="2"
                                ...
                                <tr>
                                    <td>
                                        <div style="height: 19em; overflow: auto;">
                                            <asp:GridView ID="gvRolls" AllowPaging="false" DataKeyNames="RoleName" AutoGenerateColumns="False"
                                                runat="server" OnRowDeleting="gvRolls_RowDeleting">
                                                <Columns>
                                                    <asp:TemplateField ShowHeader="False">
                                                        <ItemTemplate>
            ...
            <asp:Panel runat="server" CssClass="newitempopup" Width="400" ID="pnlChangePassword">
                <asp:Panel runat="server" CssClass="newitemtitle" ID="pnlChangePasswordTitleId">
                    <span>Change </span>
                    <asp:Label ID="lblNameOfUserWhosePasswordWereChanging" runat="server"></asp:Label><span>'s
                        Password</span>
                </asp:Panel>
                <asp:Panel runat="server" ID="pnlChangePasswordContent" CssClass="newitemcontent">
                    ...
                    <table cellpadding="4">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Label ID="lblNewPasswordMessage" ForeColor="Red" Font-Bold="true" runat="server"
                                    Text=""></asp:Label>
                            </td>
                        </tr>
                    </table>
