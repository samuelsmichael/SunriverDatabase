...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h2>
                Security Admin</h2>
            <center><table width="100%" cellpadding="3" cellspacing="3" border="0">
                <tr valign="top">
                    <td>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td>
                                    <asp:GridView ID="gvRolls" AllowPaging="True" DataKeyNames="RoleId" AutoGenerateEditButton="True"
                                        AutoGenerateColumns="False" runat="server" OnRowCancelingEdit="gvRolls_RowCancelingEdit"
                                        OnRowDeleting="gvRolls_RowDeleting" OnRowEditing="gvRolls_RowEditing" OnRowUpdating="gvRolls_RowUpdating"
                                        Caption="Rolls" OnRowCommand="gvRolls_RowCommand">
                                        <Columns>
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbRollDelete" runat="server" CommandName="DeleteRoll" OnClientClick="return confirm('Are you sure you want to delete this entry?');">Delete </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="RollId" HeaderText="RollId" Visible="false" />
                                            <asp:BoundField DataField="RoleName" HeaderText="Name" ControlStyle-Width="110" />
                                        </Columns>
                                    </asp:GridView>
                                </td>
                            </tr>
