...
<asp:Content ID="Content4" ContentPlaceHolderID="NewItemContent" runat="server">
    ...
    <asp:Panel runat="server" CssClass="newitempopup" ID="pnlNewBPermitId">
        ...
        <table width="100%">
            <tr>
                <td>
                    <asp:Button ID="btnNewBPermitOk" runat="server" Text="Okay" 
                        onclick="btnNewBPermitOk_Click" />
                </td>
                <td>
                    <asp:Button ID="btnNewBPermitCancel" OnClientClick="return onNewBPermitCancel()" runat="server" Text="Cancel" />
                </td>
            </tr>
        </table>
        </asp:Panel>
    ...
    <ajaxToolkit:ModalPopupExtender ID="mpeNewBPermit" runat="server" TargetControlID="lbBPermintNew"
        PopupControlID="pnlNewBPermitId" BackgroundCssClass="modalBackground"
        PopupDragHandleControlID="pnlNewBPermitTitleId"
