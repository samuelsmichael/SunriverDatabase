...
namespace SubmittalProposal.Reports {
    public partial class RVRenewNow2 : AbstractReport {
        ...
        protected override Hashtable getReportParams() {
            ...
            reportParams.Add("@IsPastDueReport", false);
            reportParams.Add("ReportHeading", "Renew Now RV Storage Accounts");
            reportParams.Add("SideBarHeading", "Renew Now Cutoff Date");
            return reportParams;
        }
