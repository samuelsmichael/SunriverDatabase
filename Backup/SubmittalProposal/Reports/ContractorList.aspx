<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.Master" AutoEventWireup="true"
    CodeBehind="ContractorList.aspx.cs" Inherits="SubmittalProposal.Reports.ContractorList" %>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ForeColor="Red" ID="revtbRegistrationEndDate" Display="Dynamic"
                    ValidationExpression="^(((((0[13578])|([13578])|(1[02]))[\-\/\s]?((0[1-9])|([1-9])|([1-2][0-9])|(3[01])))|(((0[469])|([469])|(11))[\-\/\s]?((0[1-9])|([1-9])|([1-2][0-9])|(30)))|((02|2)[\-\/\s]?((0[1-9])|([1-9])|([1-2][0-9]))))[\-\/\s]?\d{4})(\s(((0[1-9])|([1-9])|(1[0-2]))\:([0-5][0-9])((\s)|(\:([0-5][0-9])\s))([AM|PM|am|pm]{2,2})))?$"
                    ControlToValidate="tbRegistrationEndDate" runat="server" ErrorMessage="Please enter a valid date"></asp:RegularExpressionValidator>
